...
I'm a recent college graduate from Western Governors University (B.S - Cybersecurity and Information Assurance) with a strong foundation in security operations, system administration, network defense, and security automation. I enjoy identifying vulnerabilities, analyzing threats, and building practical solutions that improve security and operational efficiency.
...
Network Security & Traffic Analysis<br/>
Security Automation with Python & Bash<br/>
...
## Tools
<B>Security Tools:</B> Wazuh, Splunk, Wireshark, Nmap, Nessus, OWASP ZAP, Zeek, Snort<br/>
<B>Languages:</B> Python, Bash, SQL<br/>
<B>Operating Systems:</B> Windows, Windows Server, Kali Linux, Ubuntu Linux, Mint Linux<br/>
...
## Projects
<a href="https://github.com/MRC18014/MRC18014/blob/main/SIEM.md">Home SIEM server and agents</a>
